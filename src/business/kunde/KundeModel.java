...
public final class KundeModel {
    ...
    // NEW: gibt die Hausnummer des aktuellen Kunden zurueck
    /**
     * gibt die Hausnummer des aktuellen Kunden zurueck
     * @return Integer, Hausnummer oder null falls kein Kunde gesetzt
     */
    public Integer getAktuelleHausnummer() {
        if (this.kunde == null) {
            return null;
        }
